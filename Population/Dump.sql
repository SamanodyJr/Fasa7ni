...
INSERT INTO `Address` VALUES ('Adrenaline Park-Laser Tag','Dandy Mall, 28km, Cairo - Alex Desert Rd, Giza Governorate','Giza'),('Alexandria Bibliotheca','Bab Sharqi, Alexandria Governorate 21526','Alexandria'),('B-URN','Swan Lake compound, New Cairo, Egypt Cairo, Egypt','New Cairo'),('BeFit 360','New Cairo 1, Cairo Governorate 4740211','New Cairo'),('Bounce Egypt','Nasr City, Cairo Governorate 11765','Nasr City'),('BRGR','The drive by the waterway, New Cairo 1, Cairo Governorate 4720110','New Cairo'),('Brown Nose Coffee','5A By The Waterway, New Cairo 3, Cairo Governorate','New Cairo'),('Bunker','One Golden Square Mall, El Nasr, Lower Ground level, street branched from 90th road, New Cairo 3, Cairo Governorate','New Cairo'),('C.O.D.E Paintball Egypt','3F7Q+VHV, Second New Cairo, Cairo Governorate 4750301','New Cairo'),('Cairo Tower','Kasr Al Nile, Zamalek, Cairo Governorate 4270024','Zamalek'),('Citadel of Salah El-Din','27H6+G27, Privet Entrance Bel Kalaa, Al Abageyah, El Khalifa, Cairo Governorate 4252360','Cairo'),('Go!Padel','Katameya heights, New Cairo 1, Cairo Governorate 4721010','New Cairo'),('Nile Kayak Club','Kornish Al Nile, Al Isaweyah, El Basatin, Cairo Governorate 4220004','Cairo'),('Osana','4 Al Nadi, Street, Maadi, Cairo Governorate 4212220','Maadi'),('Sizzler','17 Road 231 Maadi Degla, Cairo Governorate 11211','Maadi'),('Spectra','14 Abd El-Hameed Lotfy St., From El Batal A.Abd El Aziz St, Giza','Giza'),('The Egyptian Museum in Cairo','El-Tahrir Square, Ismailia, Qasr El Nil, Cairo Governorate 4272083','Ismailia'),('The Great Pyramid of Giza','Al Haram, Nazlet El-Semman, Al Haram, Giza Governorate 3512201','Giza'),('The House','Street 279, Ezbet Fahmy, El Basatin, Cairo Governorate 4234006','Cairo'),('What the Crust','275 Mokarrar Street, Ezbet Fahmy, El Basatin, Cairo275 Mokarrar Street, Ezbet Fahmy, El Basatin, Cairo','Cairo');
...
INSERT INTO `Fosa7_Cats` VALUES ('Activities','Heggo','Laser Tag','2024-07-25','18:00:00'),('Sightseeing','nouryasser1','One of the 7 wonders?','2024-07-19','10:00:00'),('Sports','samanodyjr','Padel?','2024-07-20','19:00:00');
...
CREATE TABLE `Fosa7_Requests` (
  ...
  KEY `Host_Username` (`Host_Username`,`Fos7a_Name`,`Fos7a_Date`,`Fos7a_Time`),
